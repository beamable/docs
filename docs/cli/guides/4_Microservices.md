...
Before you can develop a Beamable Standalone Microservice, you need to complete the [Getting-Started Guide](0_Getting-Started.md). That means having [Dotnet 8](https://dotnet.microsoft.com/en-us/download/dotnet/8.0) installed, and getting the  [Beam CLI](https://www.nuget.org/packages/Beamable.Tools). 
...
| `MyProject/services/Dockerfile`        | When the Standalone Microservice is deployed, it will be containerized using Docker. You can modify the Dockerfile to extend the capabilities of the service. See the [Deployment Section](5_Microservice-Deployment.md#Dockerfiles) for more details |
...
- [Deploy your Microservice to the Beamable Cloud](5_Microservice-Deployment.md)
- [Debugging Techniques](6_Microservice-Debugging.md)
