...
**Before starting this guide, complete the [Setup](../../getting-started/setup.md) process for the SDK and make sure the editor is not running.**
...
Linking a project tells the CLI where to put the generated C++ files for communicating with the Microservice from UE code. **To generate the project files, run**:
...
MicroStorages are a Beamable service that allows you, the Game-Maker, access to a MongoDB you can use to define your own custom persisted data formats to go along with your own custom microservice logic.
