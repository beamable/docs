...
|-|-|-|
|--id|Int64|The player or account id to fetch tokens for. When blank, the current player id will be used|
|--offset|Int32|The offset|
|--length|Int32|The max size of the response|
|--cid|Int64|A cid|
|--pid|String|A pid|
