...
```shell
beam telemetry collector get [options]
```
...
|-|-|-|
|--platform|String|The platform for the collector executable. [osx, win, lin] or defaults to system|
|--arch|String|The architecture for the collector executable. [arm64, x64] or defaults to system|
...
### Parent Command
[telemetry collector](./collector.md)
