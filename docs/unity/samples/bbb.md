...
| Step | Detail |
|------|--------|
| 1. Setup Beamable Microservices | • See [Getting Started With Beamable Microservices](../user-reference/cloud-services/microservices/microservice-framework.md) |
...
| 9. Publish the content | • Press the "Publish" button in the Content Manager Window. See [Content Manager](../user-reference/beamable-services/profile-storage/content/content-overview.md#content-management) for more info. |
