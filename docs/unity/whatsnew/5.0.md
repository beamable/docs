...
As of January 2026, the Beamable Chat service is deprecated. If your game is already using Chat, it is possible to continue using the feature by configuring "bring your own key" settings. See the [Beamable Chat Documentation](../user-reference/beamable-services/social-networking/chat/) for details on how to set up your keys for Chat.
