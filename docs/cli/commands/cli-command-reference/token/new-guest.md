...
|-|-|-|
|--key|Set[String]|The keys for initProperties. The count must match the count of the --value options|
|--value|Set[String]|The values for the initProperties. The count must match the count of the --key options|
