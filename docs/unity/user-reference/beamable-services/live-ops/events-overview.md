...
| 2. Create the "Event" content                             | ![Content Manager Create Content](../../../../media/imgs/beamable-content-manager-create-event.png)<br/>• Select the content type in the list<br/>• Press the "Create" button<br/>• Populate the content name                       |
