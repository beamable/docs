...
!!! warning "Gotchas"
    ...
    • While Beamable supports _minor_ edits to the player data from Portal, restoring a customer's player data completely to a historic backup state is **not supported**.
