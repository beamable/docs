...
|-|-|-|
|--player-id|Int64|The playerId (gamerTag) for the player to open Portal|
|--token|String|The token for the player to open Portal. Cannot be specified when --player-id is set|
