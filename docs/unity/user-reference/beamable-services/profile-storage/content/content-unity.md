...
| [`MustBeComparatorString`](https://csharp.cdocs.beamable.com/latest/classBeamable_1_1Common_1_1Content_1_1Validation_1_1MustBeComparatorString.html) | Ensures field value is one of the comparator strings `eq`, `ne`, `gt`, `ge`, `lt`, `le` |
