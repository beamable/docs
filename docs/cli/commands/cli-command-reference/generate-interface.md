...
## About
[INTERNAL] Generates C# code for interfacing with the CLI from Unity
...
|--engine|String|Filter which engine code we should generate (unity | unreal). An empty string matches everything|
