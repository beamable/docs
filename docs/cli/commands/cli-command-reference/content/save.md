...
|--content-ids|String[]|An array of existing content ids|
|--content-properties|String[]|An array, parallel to the --content-ids, that contain the escaped properties json for each content|
|--force|Boolean|When this is set, this will ignore your local state and save the properties directly to disk|
