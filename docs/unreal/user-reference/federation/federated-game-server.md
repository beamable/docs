...
- **Beam PIE's Fake Lobby**: This is an In-Band call made by [Beam PIE's Fake Lobby setup](../editor-systems/pie-settings.md). You can read more about this in our [Real Time Multiplayer Guides](../realtime-multiplayer/realtime-multiplayer-overview.md).
...
For the In-Band calls (**Provision Game Server for Lobby** and **BeamPIE's Fake Lobby**), as long as your microservice is running, your PIE clients will invoke it and that's that.
