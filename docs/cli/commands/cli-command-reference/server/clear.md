...
|-|-|-|
|--version|String|Only match servers that match the given version|
|--owner|String|Only match servers that match the given owner|
|--port|Int32|Only match servers that match the given port|
|--pid|Int32|Only match servers that match the given process id|
