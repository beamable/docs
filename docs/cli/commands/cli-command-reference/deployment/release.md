...
```shell
beam deployment release [options]
```
...
|--max-parallel-count|Int32|Maximum number of parallel services builds|
...
|--from-latest-plan|Boolean|Use the most recent plan generated from the plan command|
