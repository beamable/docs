...
![The player Inventory page in Portal, showing currency balances and owned items.](../media/imgs/Portal-Inventory-1.png)
...
![The currency table with a row's action menu open, showing the Edit Currency option.](../media/imgs/Portal-Inventory-2-1-edit-currency.png)

![The Edit Currency dialog, adjusting the gems balance.](../media/imgs/Portal-Inventory-2-2-edit-currency.png){width="400px"}
...
![An expanded inventory item showing its properties, with the action menu open to edit or delete it.](../media/imgs/Portal-Inventory-3-1-edit-item.png)

![The Add Item dialog, with fields for an item and its properties.](../media/imgs/Portal-Inventory-3-add-item.png){width="400px"}
