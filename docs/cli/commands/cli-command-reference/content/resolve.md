...
|--use|String|Whether to use the 'local' or 'realm' version of the conflicted content.<br>This applies to ALL matching elements of the filter that are conflicted.<br>Value must be "local" or "realm"|
