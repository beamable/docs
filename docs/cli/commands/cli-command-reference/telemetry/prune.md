...
|-|-|-|
|--delete-all|Boolean|If set, will delete all telemetry files|
|--retaining-days|Int32|Can be passed to define a custom amount of days in which data should be preserved|
|--process-id|String|Defines the process Id that called this method. If is not passed a new process ID will be generated|
