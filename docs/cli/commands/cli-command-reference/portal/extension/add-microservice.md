...
```shell
beam portal extension add-microservice <extension> <microservice> [options]
```
...
|microservice|String|The Microservice that will be a new dependency of the specified Portal Extension|
