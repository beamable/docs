...
|-|-|-|
|--limit|Int32|How many package versions to display|
|--include-rc|Boolean|Should release candidates be shown|
|--include-release|Boolean|Should stable releases be shown|
