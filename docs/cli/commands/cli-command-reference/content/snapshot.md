...
|--snapshot-type|ContentSnapshotType|Defines where the snapshot will be stored to.<br>Local => Will save the snapshot under `.beamable/temp/content-snapshots/[PID]` folder<br>Shared => Will save the snapshot under `.beamable/content-snapshots/[PID]` folder|
