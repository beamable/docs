...
slug: "cli-services-register"
excerpt: "Registers a new service into the local manifest"
hidden: false
metadata: 
  image: []
  robots: "index"
...
---
```shell
beam services register [options]
```
...
| --type                                       | Nullable\`1 | The type of protocol this service implements: HttpMicroservice,EmbeddedMongoDb                                                     |
...
|--base-image|String|Name and tag of the base image to use for the local mongo db instance|  
