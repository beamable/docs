...
#### Snapshots editor
The Snapshots Editor allows you to create and manage snapshots of your content. You can take a snapshot at any time, giving you a backup of your content that you can restore later if needed. This is particularly useful for testing changes or experimenting with new ideas without the risk of losing your current work. We also automatically take a snapshot of your content every time you publish (named "LastPublish") that is version-controlled.
