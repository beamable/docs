...
2. Clone the UnrealSDK Repository
      - Clone the [UnrealSDK](https://github.com/Beamable/UnrealSDK) repository if you have not already
...
3. Run the `BeamableUnreal` Project and in the editor, go to Project Settings → Beamable Core → Beamable Environment and verify it is set to `BeamProdEnv`
...
!!! warning "Clean Up Sample Realms"
      If you are using your own organization (the one you will use to ship your game) to test any of these samples, do not forget to delete the test realms when you are finished exploring!
...
- Those implementations are only related to the specificity of this sample configuration; they are not related to the samples' content
