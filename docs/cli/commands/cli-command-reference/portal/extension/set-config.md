...
```shell
beam portal extension set-config [options]
```
...
|-|-|-|
|--file-extensions-to-observe|Set[String]|Extra file extensions to include in the watch process (e.g., '.md,.json'). These run alongside default extensions|
