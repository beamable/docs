...
```shell
beam project add-replacement-type [options]
```
...
|-|-|-|
|--reference-id|String|The reference Id (C# class/struct name) for the replacement|
|--replacement-type|String|The name of the Type to replaced with in Unreal auto-gen|
|--optional-replacement-type|String|The name of the Optional Type to replaced with in Unreal auto-gen|
|--engine-import|String|The full import for the replacement type to be used in Unreal auto-gen|
|--project-name|String|The Unreal project name|
