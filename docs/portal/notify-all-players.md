...
To collect this message and display it in the game client using Unity, use the following code which should go inside a class that inherits from `MonoBehaviour`:
