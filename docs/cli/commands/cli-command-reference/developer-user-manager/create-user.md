...
```shell
beam developer-user-manager create-user [options]
```
...
|-|-|-|
|--rolling-buffer-size|Int32|The max amount of captured users that you can have before starting to delete the oldest (0 means infinity)|
|--alias|String|The alias is a chosen name for this player which is not the same as the player name in the backend|
|--template|String|A gamer tag to a template that will be used to copy the stats and inventory to the created player|
|--description|String|A shortly description of this new player|
|--user-type|Int32|The user type of this player 0 - Captured 1 - Local 2 - Shared|
|--tags|Set[String]|A list of tags to set in this new player (only locally)|
...
### Parent Command
[developer-user-manager](./developer-user-manager.md)
