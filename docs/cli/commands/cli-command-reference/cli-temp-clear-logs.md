---
title: "Temp Clear Logs"
slug: "cli-temp-clear-logs"
excerpt: "Clear temp log files"
hidden: false
createdAt: "Wed Dec 04 2024 11:27:32 GMT+0000 (Coordinated Universal Time)"
updatedAt: "Tue Oct 14 2025 19:06:37 GMT+0000 (Coordinated Universal Time)"
---
```shell
...
| ------------ | ------ | ------------------------------------------------------------------------------------- |
| --older-than | String | Only clear logs older than a given value. This string should be in a duration format. |
