...
```shell
beam unity update-dlls <service> [options]
```
...
|Name|Type|Description|
|-|-|-|
|--paths|Set[String]|The path of the dll that will be referenced|
|--names|Set[String]|The name of the dll that will be referenced|
