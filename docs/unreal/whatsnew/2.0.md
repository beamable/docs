# Version 2.0.1
This is the release notes for the The Unreal SDK version 2.0.1.
...
- In order to fix a bug, this hotfix requires that you regenerate your microservice clients, if you have any. So you'll need to run: `dotnet beam project generate-client "."`
