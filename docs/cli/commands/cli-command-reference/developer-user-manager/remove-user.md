...
```shell
beam developer-user-manager remove-user [options]
```
...
|-|-|-|
|--gamer-tag|Set[String]|The gamer tag of the player that you would like to remove, it will not remove from the portal|
