...
- **Heading capitalization:** Title Case at all levels (H1–H4). This is the de facto standard across all SDK docs; sentence-case headings are outliers to be corrected. Title Case capitalizes by part of speech, not word length: verbs, nouns, adjectives, and adverbs capitalize; articles, coordinating conjunctions, and prepositions stay lowercase regardless of length (*across*, *between*, *beyond*, *against*, *without*, *throughout*, etc.). See the [Google Developer Documentation Style Guide](https://developers.google.com/style/capitalization) for the authoritative reference.
