...
```shell
beam developer-user-manager copy-state [options]
```

## About
Copy the inventory and stats state from a user to another
...
|-|-|-|
|--source|String|The identifier to the source user to copy from|
|--target|String|The identifier to the target user to copy to|
