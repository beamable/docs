...
```shell
beam project update-unity-beam-package <path> [options]
```
...
|Name|Type|Description|
|-|-|-|
|--version|String|Version of beam package|
|--repository|BeamNexusRepository|Beamable repository to use|
|--skip-server-package|Boolean|Skips adding server package|
