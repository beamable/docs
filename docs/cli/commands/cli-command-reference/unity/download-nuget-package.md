...
```shell
beam unity download-nuget-package <packageId> <packageVersion> <src> <dst> [options]
```
...
|-|-|-|
|packageId|String|the nuget id of the package dep|
|packageVersion|String|the version of the package|
|src|String|the file path inside the package to copy|
|dst|String|the target location to place the copied files|
