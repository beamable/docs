...
```shell
beam project storage restore <beamoId> [options]
```
...
|Name|Type|Description|
|-|-|-|
|--merge|Boolean|When true, merges the snapshot into the existing data|
|--input|String|The input for the snapshot|
