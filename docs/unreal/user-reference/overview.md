...
- **BeamableCoreEditor** and **BeamableCoreRuntimeEditor** contains `UBeamEditor` and the editor integration code: custom BlueprintNodes, PropertyCustomizations, etc.
