...
|-|-|-|
|--key-values|Set[String]|A list of realm config key/value pairs in a 'namespace|key::value' format|
|--namespaces|Set[String]|A list of realm config namespaces to filter|
