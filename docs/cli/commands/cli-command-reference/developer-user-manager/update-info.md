...
```shell
beam developer-user-manager update-info [options]
```
...
|-|-|-|
|--alias|String|A alias (Name) of the user, which is not the same name as in the portal|
|--gamer-tag|String|The gamer tag of the user to be updated|
|--description|String|A new description for this user|
|--tags|Set[String]|The tags to set in the local user data|
