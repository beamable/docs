...
```shell
beam project generate web-client [options]
```
...
|-|-|-|
|--output-dir|String|The directory where the generated code will be written|
|--lang|String|The language of the generated code. Valid values are: `typescript` (default), `ts`, `javascript`, `js`|
