...
|--ms-public-private|unknown|Whether the Runtime MS Module splits files into Public/Private folders|
...
|--bp-public-private|unknown|Whether the UncookedOnly module for BP Nodes splits files into Public/Private folders|
