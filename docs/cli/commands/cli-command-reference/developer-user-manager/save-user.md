...
|-|-|-|
|--alias|Set[String]|A alias (Name) of the user, which is not the same name as in the portal|
|--description|Set[String]|A new description for this user|
|--user-type|Int32|The user type of the user|
|--pid|Set[String]|The PID of the user|
|--cid|Set[String]|The CID of the user|
|--gamer-tag|Set[String]|The Gamer Tag of the user|
|--access-token|Set[String]|The access token to be saved|
|--refresh-token|Set[String]|The refresh token to be saved|
|--expires-in|Set[String]|The expires to be saved|
|--tags|Set[String]|The tags to set in the local user data splited by @@|
