...
```shell
beam developer-user-manager [options]
```

## About
The command that manages the developer users
...
### Sub Commands
- [clean-captured-user-buffer](./clean-captured-user-buffer.md)
- [copy-state](./copy-state.md)
- [create-user](./create-user.md)
- [create-user-batch](./create-user-batch.md)
- [ps](./ps.md)
- [remove-user](./remove-user.md)
- [save-user](./save-user.md)
- [update-info](./update-info.md)
