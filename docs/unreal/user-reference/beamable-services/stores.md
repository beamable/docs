...
Beamable's Store feature enables game-makers to create and manage dynamic in-game storefronts where players can purchase
items using virtual currencies. Stores support various features including:
