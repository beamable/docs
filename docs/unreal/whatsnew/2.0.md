...
- To fix a bug, this hotfix requires that you regenerate your microservice clients after rebuilding the microservice projects, if you have any. So you will need to run: `dotnet beam project generate-client "."`
...
This is a major release in our release cycle, it brings a lot of new features and improvements to the Beamable Unreal SDK support and user experience in general including a new Content Editor, a complete overhaull of our blueprint nodes, support for Friends and Parties, new support for Android and many others.

Follow the [Upgrade Steps](../getting-started/setup.md#upgrading-the-sdk). Then do the following:
...
![The reworked CLI-backed Content window listing content types such as BeamCurrencyContent and BeamItemContent, with the currency.gems object selected and its properties in the right-hand detail panel.](../../media/imgs/contentv2-window.png)
