...
Then, once you have tested that the new content in your environment looks correct, you can go into Portal to promote the "Dev" content to "Staging" and eventually "Production".
