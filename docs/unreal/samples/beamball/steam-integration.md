...
![A wide Blueprint graph that obtains the Steam auth session ticket and Steam ID and passes them into Beamable's Login - Federated Identity operation, then enables the login UI buttons.](../../../media/imgs/steam-demo-login.png)
