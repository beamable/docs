...
If you are upgrading from version 2.2.0, the upgrade process is simple:
...
If you are upgrading from version 2.1.0, the upgrade process is simple:
...
1. Quit the Unreal Editor so that it releases its folder locks
...
4. Open your project in Unreal Engine again
