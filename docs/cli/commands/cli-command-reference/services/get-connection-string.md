...
```shell
beam services get-connection-string <storage-name> [options]
```
...
|Name|Type|Description|
|-|-|-|
|--remote|Boolean|The Microstorage remote connection string|
|--quiet|Boolean|Ignores confirmation step|
