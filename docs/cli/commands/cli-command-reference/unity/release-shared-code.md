...
```shell
beam unity release-shared-code <csprojPath> <unityPath> <packageId> <packageRelativePath> <relativeSrc> [options]
```
...
|unityPath|String|relative path to Unity destination for src files|
|packageId|String|the name of the package to copy into|
|packageRelativePath|String|relative path to Unity destination for src files|
|relativeSrc|String|relative path to src files|
