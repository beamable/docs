...
|-|-|-|
|--type|String|Filter the federations by the type|
|--id|String|Filter the federations by the service name|
|--fed-ids|String|Filter the federation by its federation id|
