...
These are the release notes for the Unreal SDK version 2.3.0. This release includes several new features, improvements, and bug fixes to enhance your experience with the Beamable Unreal SDK. Below are the highlights of this release:
