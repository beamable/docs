...
|-|-|-|
|--service|String|The name of the service to list the dependencies of|
|--all|Boolean|If this is passed and set to True, then all references of the service will be listed|
|--non-beamo|Boolean|If this is passed and set to True, then all references that are not storages or microservices will be listed|
