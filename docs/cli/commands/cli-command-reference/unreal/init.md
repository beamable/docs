...
```shell
beam unreal init <unrealSdkRepoPath> <uprojectFilePath> <installOss> [options]
```
...
|uprojectFilePath|String|Path to the .uproject file of your project|
|installOss|Boolean|Whether or not we are installing the OnlineSubsystemBeamable|
