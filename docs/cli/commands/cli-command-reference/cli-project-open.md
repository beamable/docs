---
title: "Project Open"
slug: "cli-project-open"
excerpt: "Open the solution file for all services"
hidden: false
...
[block:parameters]
{
  "data": {
    ...
    "1-0": "--only-generate",
    "1-1": "Boolean",
    "1-2": "Only generate the sln but do not open it",
    "2-0": "--from-unity",
    "2-1": "Boolean",
    "2-2": "Use a solution filter that hides projects that aren't writable in a Unity project",
    "3-0": "--dryrun",
    "3-1": "Boolean",
